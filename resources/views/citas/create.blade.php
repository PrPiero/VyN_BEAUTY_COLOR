                ...
                <div style="max-width: 48%;"class="col-sm pt-5 p-4 mt-4">
                        ...
                        <div class="row p-2">
                            ...
                            <div class="d-flex flex-column flex-nowrap">
                                ...
                                <input class="order-2 p-2" name="telefono" type="number" maxlength="9" minlength="7" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" />
